        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              >
                <option value="admin" className="bg-emerald-900">Administrator</option>
                <option value="clerk" className="bg-emerald-900">Sales Clerk</option>
              </select>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 disabled:from-emerald-700 disabled:to-emerald-800 text-white font-bold py-4 rounded-xl transition-all duration-300 shadow-lg hover:shadow-emerald-500/30 disabled:cursor-not-allowed transform hover:-translate-y-0.5"
            >
              {loading ? (
