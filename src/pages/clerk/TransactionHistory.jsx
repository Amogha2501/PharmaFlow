...
const TransactionHistory = () => {
  ...
  const fetchTransactions = async () => {
    try {
      // In a real app, this would fetch transactions for the current clerk
      // For now, we'll use the sales history endpoint
      const response = await api.get('/sales/history/clerkId'); // clerkId would be dynamic
