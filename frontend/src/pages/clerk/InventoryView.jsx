            ...
            <div className="mb-6">
              <div className="relative w-full md:w-1/3">
                <input
                  ...
                  className="w-full px-4 py-2 pl-16 bg-white border border-emerald-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-emerald-900 placeholder-emerald-900"
                  value={searchTerm}
                      ...
                      currentProducts.map((product) => {
                        ...
                        return (
                          <tr key={product.id} className="hover:bg-emerald-50 transition-all duration-200">
                            ...
                            <td className="px-6 py-4 text-right text-emerald-900 font-semibold">${parseFloat(product.price).toFixed(2)}</td>
                            ...
                            <td className="px-6 py-4 text-emerald-700">{product.expiryDate}</td>
